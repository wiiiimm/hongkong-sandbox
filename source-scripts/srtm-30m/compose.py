...
# ---------- town clusters ----------
lonL,lonR,Wfull,x0=113.818359375,114.06005859375,2816,239
def screenx(lon): return ((lon-lonL)/(lonR-lonL)*Wfull - x0)*sc
def town(cx, kind):
...
town(screenx(113.9985),'low')     # Mui Wo
town(screenx(114.0225),'high')    # Discovery Bay
...
feats=[
 (113.8625,"大澳","Tai O","4 m","coast", -10, 0.62),
 (113.9205,"鳳凰山","Lantau Peak","934 m","peak", 0, 0.0),
 (113.9535,"大東山","Sunset Peak","869 m","peak", 0, 0.16),
 (113.9625,"二東山","Yi Tung Shan","747 m","peak", 18, 0.34),
 (113.9745,"蓮花山","Lin Fa Shan","766 m","peak", 26, 0.16),
 (113.9985,"梅窩","Mui Wo","6 m","coast", 0, 0.62),
 (114.0125,"老虎頭","Lo Fu Tau","465 m","peak", 0, 0.40),
 (114.0225,"愉景灣","Discovery Bay","12 m","coast", 16, 0.66),
]
