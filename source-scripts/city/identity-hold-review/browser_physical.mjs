...
const groups=[{id:'langham-ancillary',uids:['landsd/81387:0']}];
...
const output=new URL('docs/astra-city/identity-hold-review/browser-physical/',root);await mkdir(output,{recursive:true});
