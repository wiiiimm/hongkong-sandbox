...
const path='source-scripts/city/identity-hold-review/candidates/',catalogue=await read(path+'catalogue.json'),models=new Map(catalogue.models.map(m=>[m.uid,m]));
const groups=[{id:'masterpiece',uids:['landsd/205478:0']},{id:'west-kowloon-station',uids:['landsd/297401:0']},{id:'airport-terminal-1-part',uids:['landsd/314191:0']},{id:'langham-ancillary',uids:['landsd/81387:0']},{id:'aigburth',uids:['landsd/93890:0']}];
...
const output=new URL('docs/astra-city/identity-hold-review/browser/',root);await mkdir(output,{recursive:true});
...
try{
 for(const mobile of process.env.IDENTITY_FOUNDATIONS_ONLY? [false]:[false,true]){
  ...
  let inject=false;const url='city/data/official-models/identity-hold-review/catalogue.json';
