...
def report(plan,network):
 ...
 for target in plan['targets']:
  ...
  rows.append({**target,'outcome':outcome,'sourceCoverageComplete':bool(complete and parts),'standardMatch':any(model['exactCSUIDMatch']for model in models),'models':models,'sheetsChecked':parts})
