...
const browser=await chromium.launch({headless:true,executablePath:'/Applications/Google Chrome.app/Contents/MacOS/Google Chrome',args:['--enable-webgl','--ignore-gpu-blocklist']}),page=await browser.newPage({viewport:{width:1280,height:900}}),report={diagnostic:true,views:[],errors:[],limits:['Unrelated buildings hidden only in this diagnostic browser; terrain, model geometry and native heights are unchanged.','Opposite east/west elevated views with camera kept above intervening terrain; not exhaustive facade inspection or mobile validation.']};
try{
