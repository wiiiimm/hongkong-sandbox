"""Exact source-terrain pass for the Cheung Sha / Tong Fuk / Shui Hau government batch.
...
ROOT = HERE.parents[2]
BATCH = "government-cheung-sha-south-989-20260921"
...
def exact():
    ...
    assert set(geometries) <= set(selection) and len(selection) == 989
