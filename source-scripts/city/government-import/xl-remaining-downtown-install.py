"""Publish Downtown 38 unchanged XL source after staged and live checks."""
...
DOC = ROOT / "docs/astra-city/government-import/government-xl-remaining-20260923/downtown"
...
def owned():
    ...
    for model in catalogue["models"]:
        ...
        parts[model["uid"]] = {
            ...
            "classification": "script-verified-original-government-xl-same-parent-podium",
            "knownHold": False,
        }
    ...
    save(inventory_path, {**inventory, "snapshotId": snapshot, "derivedFrom": pointer["snapshotId"],
                          "parts": ordered, "qualification": "Downtown 38 unchanged government XL tower accepted with bounded same-parent source excess, retained solid podium support, runtime and staged browser checks. No geometry changes or per-model AI."})
    ...
    observation = ("Exact unchanged government Downtown 38 XL tower. Object ID, Building CSUID, source hash, "
                   "projected identity, bounded same-parent source excess and unique unchanged podium support passed scripted checks. "
