"""Exact source-terrain pass for the Pui O / Chi Ma Wan government batch.
...
def exact():
    ...
    assert set(selection) == set(geometries) and len(selection) == 362
    ...
    report = {
        ...
        "qualification": (
            "All 362 sources received exact identifier, projected assembly, and full-face "
