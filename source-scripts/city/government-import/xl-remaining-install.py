"""Publish the three verified unchanged XL sources through the guarded reviewer."""
...
DOC = ROOT / "docs/astra-city/government-import/government-xl-remaining-20260923/direct"
...
def owned():
    ...
    save(inventory_path, {**inventory, "snapshotId": snapshot, "derivedFrom": pointer["snapshotId"],
                          "parts": ordered, "qualification": "Three unchanged government XL parts accepted by exact identity, current terrain, runtime and staged browser checks. No geometry changes or per-model AI."})
    ...
    observation = ("Exact unchanged government XL source. Object ID and Building CSUID, source hash, "
                   "projected identity, neighbouring forms, current terrain, mobile budget and staged "
