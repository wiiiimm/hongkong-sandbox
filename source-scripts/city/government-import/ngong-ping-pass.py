"""Process all matched, uninstalled Ngong Ping / Lantau peaks government forms; never AI."""
...
def prepare():
    ...
    frozen = {
        ...
        "selectionPolicy": "All matched uninstalled forms in review section 10.11 Ngong Ping, Big Buddha, Lantau Peak and Sunset Peak",
