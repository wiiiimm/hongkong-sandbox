"""Stage unchanged XL sources that pass exact identity, terrain and runtime gates."""
...
BATCH = "government-xl-remaining-direct-20260923"
BASE = ROOT / "docs/astra-city/government-import/government-xl-remaining-20260923"
DOC = BASE / "direct"
LOCAL = HERE / "local" / BATCH
STAGE = HERE / "accepted" / BATCH
UIDS = ("landsd/12663:0", "landsd/3844:0", "landsd/33933:0")
...
def owned():
    ...
    assert sha(manifest) == selection["manifestSHA256"]
    ...
    for uid in UIDS:
        ...
        entry.update(priority="landmark", placementReviewed=True, sourceIdentityReviewed=True,
                     ...
                     placementReview="Exact unchanged government XL source: original identifiers and SHA, bounded projected identity and neighbouring-form overlap, complete sampled terrain contact and mobile runtime checks. No AI or source geometry edits.")
    ...
    template.update(area="Remaining XL direct original government imports", models=models,
                    counts={"packedModels": len(models)},
                    loadingPolicy="Exact unchanged source; scripted identity, terrain and runtime checks")
    ...
    save(DOC / "selection.json.gz", {"batch": BATCH, "nativeRun": selection["nativeRun"],
                                     "manifestSHA256": selection["manifestSHA256"], "rows": chosen,
                                     "aiCalls": 0})
    ...
    decision = {"batch": BATCH, "policy": "original-government-xl-direct-v1",
