"""Process all matched, uninstalled Cheung Sha / Tong Fuk / Shui Hau government forms; never AI."""
...
def prepare():
    ...
    frozen = {
        ...
        "selectionPolicy": "All matched uninstalled forms in review section 10.8 Cheung Sha, Tong Fuk and Shui Hau",
