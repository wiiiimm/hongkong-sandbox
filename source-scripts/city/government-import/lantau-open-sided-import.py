"""Publish the unchanged Discovery Bay open-sided source after guarded checks."""
...
def owned():
    ...
    decision = {
        "policy": "original-government-lantau-open-sided-compute-only-v1",
    ...
    save(inventory_path, {
        **inventory,
        ...
        "parts": ordered,
        "qualification": (
            f"The open-sided collision repair enabled installation of {len(installed)} unchanged government sources after "
    ...
    installed_observation = (
        "Exact unchanged government source passed deterministic identity, visible-roof, retained-basic-support, "
    ...
    stage_name = "government-lantau-open-sided-terminal-v1"
