"""Process all matched, uninstalled Shek Pik / Fan Lau government forms; never AI."""
...
def prepare():
    ...
    frozen = {
        ...
        "selectionPolicy": "All matched uninstalled forms in review section 10.9 Shek Pik, Fan Lau and southwest Lantau",
