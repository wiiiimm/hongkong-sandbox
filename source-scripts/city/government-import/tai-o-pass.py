"""Process all matched, uninstalled Tai O / northwest villages government forms; never AI."""
...
ROOT = HERE.parents[2]
BATCH = "government-tai-o-northwest-600-20260921"
...
def prepare():
    ...
    frozen = {
        ...
        "selectionPolicy": "All matched uninstalled forms in review section 10.10 Tai O and north-west Lantau villages",
