...
| Held for unknown state / later local scripted processing | 45 |
| In process | 0 |
...
The other 45 models retain their current viewer fallbacks. Their blockers overlap:

- 29 still need a deterministic source-assembly suppression or support map.
...
The original 50-result checkpoint remains in pinned Neon job `9963d69f1a4c5c150cb119ba7409204fc9beca9c0ddb49ba2b4e85d9d7334585`. Current review snapshot `04d8813ba3dacd9e` records 5 installed and 45 held rows. Third-pass job `8a8785c85c67137ff82059ea857f957cfa3546393a463b4c48aabf8be0fe324c` stores the four refined local-compute blockers and confirms zero rows in process. The resulting public count is 404 ready government-source forms and 418 enhanced source forms overall.
