...
try{
 ...
 await visit('central');await page.locator('#time').fill('20');assert.equal((await state()).time,20);await page.screenshot({path:evidence+'central-night-1440x1000.png'});
 ...
 await page.locator('#time').fill('15');await visit('lantau');await page.screenshot({path:evidence+'tung-chung-desktop-1440x1000.png'});
