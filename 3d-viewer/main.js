...
const PLANE_GLBS = {
  ...
  cx777: { url: 'data/models/plane-777.glb?v=2', rotY: Math.PI },        // “Boeing 777-300er.”, 777_Boeing (tail at -Z; source-backed CX livery baked in; v2 busts the old jade-hull cache)
