...
const DEFAULT_TERRAIN = [
  ...
  'data/models/aircraft-prop-small-airplane.glb',
  'data/models/aircraft-cx747-boeing-747.glb',
  'data/models/aircraft-cx777-generic-airliner.glb',
  'data/models/aircraft-a350-generic-airliner.glb',
].map((f) => `${DATA_BASE}/${f}`);
